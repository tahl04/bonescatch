  ...
  {/* 튜토리얼 */}
      {
        ...
        <>
          <div className={m.guide}>
            ...
            {who.TRIBE == 1 && <img className={m.badaJokjang}></img>}
            {who.TRIBE == 2 && <img className={m.bawiJokjang}></img>}
            {who.TRIBE == 3 && <img className={m.bamJokjang}></img>}
                {
                  talkPage == "첫장" && 
                ...
                }
                {
                  ...
                  <div className={m.talk}>
                    <figure>
                      <div>
                        <h3>이 룰 안에서 모든 그림들은 {`"`}본스케치{`"`} 라고 불러</h3>
